...
//	private static Boolean verificaQuantidadeEstacao(Integer estacao) {
//		if(estacao >= 3 && estacao <= 100) {
//			return Boolean.TRUE;
//		}
//		return Boolean.FALSE;
//	}
//	
//	private static Boolean verificaLinhas(Integer estacao, Integer linhas) {
//		if(linhas >= (estacao - 1) &&
//				linhas <= (estacao * (estacao - 1)/2)
//				) {
//			return Boolean.TRUE;
//		}
//		return Boolean.FALSE;
//	}
	...
	public static void buscaEmProfundidade(List<Estacao> estacoes, Integer totalEstacao, Integer estacaoVerificar) {
		...
		for(int i = 0; i < totalEstacao; i++) {
			if(estacoes.get(i).getCor() == "BRANCO"
					&& estacoes.get(estacaoVerificar).getEstacaoLigada() == estacoes.get(i).getEstacao1()){
				buscaEmProfundidade(estacoes, totalEstacao, i);
			}
		}
		estacoes.get(estacaoVerificar).setCor("PRETO");
	}
	...
	public static void main(String[] args) {
			...
			do {
				...
				for(int i = 1; i <= L; i++){
						...
						C1 = sc.nextInt();
						C2 = sc.nextInt();
						Estacao est = new Estacao(C1, "BRANCO", C2);
